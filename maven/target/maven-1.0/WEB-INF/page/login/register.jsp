...
<script src="${ctx}/js/jquery.min.js" type="text/javascript" charset="UTF-8"></script>
    <script src="${ctx}/js/bootstrap_3.3.7_js_bootstrap.min.js"></script>
    	...
    	<form  method="post" id="registerForm" action="${ctx}/login/register">
        	<div class="zhuce_wid">
                ...
                <div class="f-cb zhuce_tt">
                    ...
                    <em>*</em>
                    <i id="emailTip2" style="font-size:14px;width:250px;font-style:normal;"></i>
                </div>
                <!-- 短信验证码-->
                <div class="f-cb zhuce_tt">
                    <span>验证码确认:</span>
                    <input type="text" placeholder="验证码" name="email" id="code1" onblur="binding()">
                    <em>*</em>
                    <i id="" style="font-size:14px;width:250px;font-style:normal;"></i>
                    <p id="tips" style="margin-left:100px;margin-top:60px;color:#35ff46;font-size:16px"></p>
                </div>
