...
$(document).ready(function(){
	...
	$("#loginName").formValidator({onshow:"请输入用户名",onfocus:"6-20位字母、数字、下划线组成",oncorrect:"该用户名可以注册"}).inputValidator({min:6,max:20,onerror:"用户名长度不满足要求"}).regexValidator({regexp:"username",datatype:"enum",onerror:"用户名格式不正确"})
	    .ajaxValidator({
	    type : "post",
		url : "${ctx}/loginAction.do?method=checkLoginName",
	...
	.ajaxValidator({
	type : "post",
	url : "${ctx}/loginAction.do?method=checkTelnum",
	...
	.ajaxValidator({
	type : "post",
	url : "${ctx}/loginAction.do?method=checkEmail",
...
<body style="background: rgba(255,255,255,1);">
    <div class="pagebody13 wid" style="width:890px;">
        ...
        <div class="pagebody13_right" style="width:630px">
            <form action="${ctx}/staffManagementAction.do?method=addStaff" method="post"  id="registerForm">
            <ul>
                <h3>新增用户</h3>
                ...
                <li><span>用户名:</span><input class="user" type="text" placeholder="用户名" name="loginName" id="loginName">  
                 ...
                 <li><span>手机号:</span><input class="user" type="text" placeholder="联系电话" name="telnum" id="telnum">
	                 <em>*</em>
                ...
                <li class="beizhu"><span>备注:</span><textarea name='remark' id='textarea' class="user11" placeholder="备注"></textarea></li> 
